...
namespace ECommerceV2
{
    public partial class PC : System.Web.UI.Page
    {
        ...
        {
            SqlDataSource1.SelectCommand = "select * from HangHoa where MaLoai = 'PC'";
        }
        ...
        protected void btnPCView_Click(object sender, EventArgs e)
        {
            Button btn = sender as Button;
            DataListItem selectedItem = (DataListItem)btn.NamingContainer;

            Label lblTabletName = (Label)selectedItem.FindControl("lblPCName");
