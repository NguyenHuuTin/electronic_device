...
{
    public partial class Smartwatch : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            SqlDataSource1.SelectCommand = "select * from HangHoa where MaLoai = 'DHTM'";
        }
        ...
        protected void btnSmartwatchView_Click(object sender, EventArgs e)
        {
            Button btn = sender as Button;
            DataListItem selectedItem = (DataListItem)btn.NamingContainer;

            Label lblTabletName = (Label)selectedItem.FindControl("lblSmartwatchName");
