...
namespace ECommerceV2
{
    public partial class Smartphone : System.Web.UI.Page
    {
        ...
        {
            SqlDataSource1.SelectCommand = "select * from HangHoa where MaLoai = 'DT'";
        }
        ...
        protected void btnSmartphoneView_Click(object sender, EventArgs e)
        {
            Button btn = sender as Button;
            DataListItem selectedItem = (DataListItem)btn.NamingContainer;

            Label lblTabletName = (Label)selectedItem.FindControl("lblSmartphoneName");
