<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Smartwatch.aspx.cs" Inherits="ECommerceV2.Smartwatch" %>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaHH" DataSourceID="SqlDataSource1" RepeatColumns="3">
        <ItemTemplate>
            ...
            <table class="dx-justification">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Label ID="lblSmartwatchName" runat="server" Text='<%# Eval("TenHH") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="dx-ac">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Button style="margin-top: 20px" ID="btnSmartwatchView" runat="server" Text="View" OnClick="btnSmartwatchView_Click" />
                    </td>
                </tr>
            </table>
            <br />
