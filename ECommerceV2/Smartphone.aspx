<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Smartphone.aspx.cs" Inherits="ECommerceV2.Smartphone" %>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaHH" DataSourceID="SqlDataSource1" RepeatColumns="3">
        <ItemTemplate>
            ...
            <table class="dx-justification">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Label ID="lblSmartphoneName" runat="server" Text='<%# Eval("TenHH") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="dx-ac">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Button style="margin-top: 20px" ID="btnSmartphoneView" runat="server" Text="View" OnClick="btnSmartphoneView_Click" />
                    </td>
                </tr>
            </table>
            <br />
