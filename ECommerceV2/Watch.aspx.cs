...
namespace ECommerceV2
{
    public partial class Watch : System.Web.UI.Page
    {
        ...
        {
            SqlDataSource1.SelectCommand = "select * from HangHoa where MaLoai = 'DHTT'";
        }
        ...
        protected void btnWatchView_Click(object sender, EventArgs e)
        {
            Button btn = sender as Button;
            DataListItem selectedItem = (DataListItem)btn.NamingContainer;

            Label lblTabletName = (Label)selectedItem.FindControl("lblWatchName");
