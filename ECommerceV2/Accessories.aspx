<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Accessories.aspx.cs" Inherits="ECommerceV2.Accessories" %>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaHH" DataSourceID="SqlDataSource1" RepeatColumns="3">
        <ItemTemplate>
            ...
            <table class="dx-justification">
                <tr>
                    <td class="dx-ac">
                        <asp:Image ID="Image1" runat="server" Height="200px" Width="230px" ImageUrl='<%# Eval("Hinhanh") %>' />
                    </td>
                </tr>
                <tr>
                    <td class="dx-ac">
                        <asp:Label ID="lblAccessoriesName" runat="server" Text='<%# Eval("TenHH") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="dx-ac">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Button style="margin-top: 20px" ID="btnViewAccessories" runat="server" Text="View" OnClick="btnViewAccessories_Click" />
                    </td>
                </tr>
            </table>
            <br />
