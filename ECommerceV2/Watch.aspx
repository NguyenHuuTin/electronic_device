<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Watch.aspx.cs" Inherits="ECommerceV2.Watch" %>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaHH" DataSourceID="SqlDataSource1" RepeatColumns="3">
        <ItemTemplate>
            ...
            <table class="dx-justification">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Label ID="lblWatchName" runat="server" Text='<%# Eval("TenHH") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="dx-ac">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Button style="margin-top: 20px"  ID="btnWatchView" runat="server" Text="View" OnClick="btnWatchView_Click" />
                    </td>
                </tr>
            </table>
            <br />
