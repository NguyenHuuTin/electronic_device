<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PC.aspx.cs" Inherits="ECommerceV2.PC" %>
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="MaHH" DataSourceID="SqlDataSource1" RepeatColumns="3">
        <ItemTemplate>
            ...
            <table class="dx-justification">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Label ID="lblPCName" runat="server" Text='<%# Eval("TenHH") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="dx-ac">
                ...
                <tr>
                    <td class="dx-ac">
                        <asp:Button style="margin-top: 20px" ID="btnPCView" runat="server" Text="View" OnClick="btnPCView_Click" />
                    </td>
                </tr>
            </table>
            <br />
